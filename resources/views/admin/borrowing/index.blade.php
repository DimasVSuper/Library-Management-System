...
<div class="min-h-screen bg-linear-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 py-8 px-4">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex justify-between items-center mb-8">
            ...
            <a href="{{ route('borrowing.create') }}" class="bg-linear-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-6 py-3 rounded-lg font-semibold transition duration-300 transform hover:scale-105">
                + Pinjam Buku
            </a>
        </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-lg shadow-md overflow-hidden">
            ...
            <table class="w-full">
                <thead>
                    <tr class="bg-linear-to-r from-blue-600 to-purple-600 text-white">
                    ...
                    <tr class="border-b border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700 transition">
                        ...
                        <td class="px-6 py-4 text-center">
                            <div class="flex gap-2 justify-center">
                                <a href="{{ route('borrowing.show', $borrowing->id) }}" class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded text-sm font-semibold transition">
                                    Lihat
                                </a>
            ...
            <div class="text-center py-12">
                <p class="text-slate-600 dark:text-slate-400 text-lg">Belum ada peminjaman. <a href="{{ route('borrowing.create') }}" class="text-blue-600 dark:text-blue-400 hover:underline font-semibold">Buat peminjaman baru</a></p>
            </div>
            @endif
        </div>
    </div>
