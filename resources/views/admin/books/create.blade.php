...
@section('content')
    <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-bold text-slate-900 dark:text-white">Tambah Buku Baru</h1>
            <p class="text-slate-600 dark:text-slate-400 mt-1">Masukkan informasi lengkap buku baru</p>
        </div>
